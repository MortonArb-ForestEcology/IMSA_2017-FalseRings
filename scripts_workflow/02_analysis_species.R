...
sum.tca$tTable[2,1]/sum.tca$sum.va$tTable[1,1] # Looking at the percent difference
...
sum.vd$tTable[2,1]/sum.vd$sum.va$tTable[1,1] # Looking at the percent difference
...
sum.va$tTable[2,1]/sum.va$sum.va$tTable[1,1] # Looking at the percent difference
